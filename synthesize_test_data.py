...
# Randomly choose matched status
match = [random.choice(["Yes", "No"]) for x in range(number_of_obs)]

# Combine everything into a dataframe
df = pd.DataFrame([emails, names, languages, times, fields, field_preferences, interests, match]).T
